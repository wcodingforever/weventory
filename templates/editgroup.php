        ...
        window.addEventListener("load", function() {
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var thisGroup = JSON.parse(xhr.responseText);
                    groupName.value = thisGroup.thisName;
                    groupDescription.value = thisGroup.thisDescription;
                    groupCategory.value = thisGroup.thisCategory;
